...
public class JwtService {
    ...
    private String secretKey ; // يجب أن يكون هذا المفتاح طويلاً بما يكفي

    public String extractUsername(String jwt) {
            return extractClaims(jwt, Claims::getSubject);
    }
    public <T> T extractClaims(String jwt, java.util.function.Function<Claims, T> claimsResolver) {
